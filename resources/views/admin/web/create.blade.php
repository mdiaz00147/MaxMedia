...
<div class="container text-center">
    ...
    <div class="page">
        <center>
            ...
            {!! Form::open(['route'=>'admin.web.store']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::select('categoria_id', $categorias, null, ['class' => 'chosen-select', 'id' => 'combobox']) !!}
            </div>
            <br>
            <div class="form-group">
...
<!--Activacion del chosen-->
<script type="text/javascript">
    $(".chosen-select").chosen();
</script>
<!--Fin de la activacion de chosen-->
@stop
