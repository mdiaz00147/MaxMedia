        ...
        <div class="subnavbar-inner">
            <div class="container">
                <ul class="mainnav">
                    ...
                    <li class="active"><a href="{{ url('referrer/report') }}"><i class="icon-list-alt"></i><span>Reports</span> </a> </li>
...
@section('script')
    ...
    <script type="text/javascript" src="{{ asset('js/client/client-report4.js') }}"></script>
