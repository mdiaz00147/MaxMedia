        ...
        <div class="subnavbar-inner">
            <div class="container">
                <ul class="mainnav">
                    ...
                    <li class="active"><a href="{{ url('referrer/account') }}"><i class="icon-user"></i><span>Account</span> </a> </li> </ul>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="widget-content ">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#biling" data-toggle="tab">Biling information</a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="account">
                                            {!! Form::model($user, array('route' => array('referrer.account.update', $user->id))) !!}
                                        ...
                                        <div class="tab-pane" id="biling">

                                            <input type="hidden" name="_method" value="PUT">
                                            <fieldset>
                                                <label><strong><h3>Payee information for Paypal</h3></strong></label>
                                                <br>

                                                <div clas="control-group">
                                                    <label class="control-label" for="">Payee name used for registering with Payoneer or paypal*</label>
                                                    <div class="control">
                                                        {!!
                                                        Form::text(
                                                        'paypal_name',
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="address">Biling Address *</label>
                                                    <div class="control">
                                                        {!!
                                                        Form::text(
                                                        'direccion_envio',
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="control">
                                                        <select name="pais" required="true" class="span6">
                                                            <option value="">...</option>
                                                ...
                                                <div class="control-group">
                                                    <label class="control-label" for="email">Email address used for registering with Payoneer *</label>
                                                    <div class="control">
                                                        {!!
                                                        Form::email(
                                                        'paypal_email',
                                        ...
                                        <div class="tab-pane" id="profile">
                                            {!! Form::model('$user',['url' => 'referrer/account/'.$user->id.'/password', 'autocomplete' => 'off']) !!}
