...
<div id="carousel_principal" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="img-responsive" src="{{ asset('images/05.png') }}" alt="Primera imagen"/>
            <div class="container">
        ...
        <div class="item">
            <img class="second-image" src="{{ asset('images/02.png') }}" alt="Segunda imagen"/>
            <div class="container">
                <div class="carousel-caption">
        ...
        <div class="item">
            <img class="third-image" src="{{ asset('images/10.png')}}" alt="Tercera imagen">
            <div class="container">
                <div class="carousel-caption">
